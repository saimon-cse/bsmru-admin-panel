            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('questionPaper.update', ['questionPaper'=>$question->id]) }}" enctype="multipart/form-data" onsubmit="sanitizeInputs()">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-2">
                            <select class="form-select" name="degree" aria-label="Select Degree">
                                ...
                                <option value="3" @if( $question->degree_id== 3) selected @endif>Doctoral</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" value="{{ $question->session }}" name="session" placeholder="e.g. 2021-2022" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="exam_year" value="{{ $question->exam_year }}" placeholder="e.g. 2022" required>
                        </div>
                    </div>
